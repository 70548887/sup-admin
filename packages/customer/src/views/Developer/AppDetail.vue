...
async function fetchDetail() {
  ...
  loading.value = true
  try {
    const res: any = await customerClient.get('/openapi/customer/App/Detail', {
      params: { app_id: appId },
    })
    detail.value = res
...
async function handleSave() {
  saving.value = true
  try {
    await customerClient.post('/openapi/customer/App/Update', {
      app_id: detail.value.app_id,
      name: editForm.name,
...
async function handleDelete() {
  try {
    ...
    await customerClient.post('/openapi/customer/App/Delete', { app_id: detail.value.app_id })
