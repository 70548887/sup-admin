      ...
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            ...
            <el-button v-if="row.status < 3" size="small" type="success" @click="$router.push(`/orders/${row.id}/handle`)">处理</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { getOrderPaging, type SupplierOrder } from '@/api/orders'
